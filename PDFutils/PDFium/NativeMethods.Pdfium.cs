...
namespace PDFutils.PDFium
{
    ...
    internal static partial class NativeMethods
    {
        ...
        public static void FPDFPage_New(IntPtr doc, int index, double width, double height)
        {
            lock (LockString)
                Imports.FPDFPage_New(doc, index, width, height);
        }
        ...
        public static IntPtr FPDFPageObj_NewImageObj(IntPtr document)
        {
            lock (LockString)
                return Imports.FPDFPageObj_NewImageObj(document);
        }

        public static void FPDFPage_InsertObject(IntPtr page, IntPtr pageObject)
        {
            lock (LockString)
                Imports.FPDFPage_InsertObject(page, pageObject);
        }

        public static bool FPDFImageObj_SetBitmap(IntPtr pages, int count, IntPtr imageObject, IntPtr bitmap)
        {
            lock (LockString)
                return Imports.FPDFImageObj_SetBitmap(pages, count, imageObject, bitmap);
        }

        public static bool FPDFImageObj_SetMatrix(IntPtr pages, double a, double b, double c, double d, double e, double f)
        {
            lock (LockString)
                return Imports.FPDFImageObj_SetMatrix(pages, a, b, c, d, e, f);
        }
        ...
        private static class Imports
        {
            ...
            [DllImport("pdfium")]
            public static extern bool FPDFImageObj_SetMatrix(IntPtr pages, double a, double b, double c, double d, double e, double f);
